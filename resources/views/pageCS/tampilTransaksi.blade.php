...
@section('content')
    ...
    <div class="container">          
        <div class="table-responsive">
            <div class="kotak">
                ...
                <table class="table table-bordered text-center" id="tableTransaksi">
                    <thead>
                    <tr>
                        <!-- <th>ID PENGADAAN</th> -->
                        <th>ID TRANSAKSI</th>
    ...
    <script>     
        ...
        let col = ['id_transaksi','kode_transaksi','tgl_transaksi','diskon','total_transaksi','status_transaksi'];
        
        //tabel transaksi
        function tampilData(){
            axios.get('http://10.53.0.175:8000/api/transaksiPenjualan')
            .then((result) => {
                ...
                for(let i=0; i<transaksi.length; i++){
                    // console.log("test3");
                    console.log(cek);
                        if(transaksi[i].status_transaksi == cek)
                        {
                            //console.log(cek);
                            ...
                            for(j=0;j<=col.length;j++){
                                td = tr.insertCell();
                                if(j==col.length){
                                    if(transaksi[i].status_transaksi == "Belum Lunas"){
                                    ...
                                    td.innerHTML = transaksi[i][col[j]];
                                }
                        }
